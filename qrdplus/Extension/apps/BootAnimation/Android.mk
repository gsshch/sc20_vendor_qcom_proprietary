...
$(shell cp -r $(LOCAL_PATH)/bootanimation1.zip $(TARGET_OUT)/vendor/Default/system/media)
$(shell cp -r $(LOCAL_PATH)/shutdownanimation.zip $(TARGET_OUT)/vendor/Default/system/media)
else
$(shell cp -r $(LOCAL_PATH)/bootanimation.zip $(TARGET_OUT)/vendor/Default/system/media/bootanimation.zip)
