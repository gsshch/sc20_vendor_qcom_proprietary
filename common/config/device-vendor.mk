...
# Try to copy these files only if they exist
  ifneq ("$(wildcard $(XML_CONF_PATH))","")
    ...
    PRODUCT_COPY_FILES := $(XML_CONF_PATH)/voicemail-conf.xml:system/etc/voicemail-conf.xml $(PRODUCT_COPY_FILES)
  endif
...
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/quec-server/quec.mk)
...
ENTERPRISE_SECURITY += libprotobuf-cpp-full
...
MM_AUDIO += MTP_WCD9326_Bluetooth_cal.acdb
MM_AUDIO += MTP_WCD9326_General_cal.acdb
MM_AUDIO += MTP_WCD9326_Global_cal.acdb
MM_AUDIO += MTP_WCD9326_Handset_cal.acdb
MM_AUDIO += MTP_WCD9326_Hdmi_cal.acdb
MM_AUDIO += MTP_WCD9326_Headset_cal.acdb
MM_AUDIO += MTP_WCD9326_Speaker_cal.acdb
MM_AUDIO += MTP_WCD9326_workspaceFile.qwsp
...
MM_CAMERA += libactuator_dw9714_f8v05a
MM_CAMERA += libactuator_dw9714_f8v05a_camcorder
MM_CAMERA += libactuator_dw9714_f8v05a_camera
...
MM_CAMERA += libchromatix_ov5675_d5v15b_common
MM_CAMERA += libchromatix_ov5675_d5v15b_preview
MM_CAMERA += libchromatix_ov5675_d5v15b_default_video
MM_CAMERA += libchromatix_ov5675_d5v15b_snapshot
MM_CAMERA += libchromatix_ov5675_d5v15b_hfr_120fps
MM_CAMERA += libchromatix_ov5675_d5v15b_hfr_90fps
MM_CAMERA += libchromatix_ov5675_d5v15b_hfr_60fps
MM_CAMERA += libchromatix_ov5675_d5v15b_zsl
MM_CAMERA += libchromatix_ov5675_d5v15b_liveshot

MM_CAMERA += libchromatix_ov8856_f8v05a_common
MM_CAMERA += libchromatix_ov8856_f8v05a_preview
MM_CAMERA += libchromatix_ov8856_f8v05a_default_video
MM_CAMERA += libchromatix_ov8856_f8v05a_snapshot
MM_CAMERA += libchromatix_ov8856_f8v05a_hfr_120fps
MM_CAMERA += libchromatix_ov8856_f8v05a_hfr_90fps
MM_CAMERA += libchromatix_ov8856_f8v05a_hfr_60fps
MM_CAMERA += libchromatix_ov8856_f8v05a_zsl
MM_CAMERA += libchromatix_ov8856_f8v05a_liveshot
...
###barnett
MM_CAMERA += libchromatix_hi843_8909_common
MM_CAMERA += libchromatix_hi843_8909_default_video
MM_CAMERA += libchromatix_hi843_8909_preview
MM_CAMERA += libchromatix_hi843_8909_snapshot
MM_CAMERA += libmmcamera_hi843_8909
...
MM_CAMERA += libmmcamera_ov5675_d5v15b
MM_CAMERA += libmmcamera_ov8856_f8v05a
...
MM_CAMERA += libmmcamera_truly_ov8856_eeprom
...
MM_CAMERA += libmmcamera2_c2d_module
MM_CAMERA += libmmcamera2_cpp_module
MM_CAMERA += libmmcamera2_isp_modules
MM_CAMERA += libmmcamera2_stats_modules
MM_CAMERA += libmmcamera2_iface_modules
MM_CAMERA += libmmcamera2_pproc_modules
MM_CAMERA += libmmcamera2_wnr_module
MM_CAMERA += libmmcamera2_imglib_modules
MM_CAMERA += libmmcamera2_sensor_modules
MM_CAMERA += libmmcamera2_vpe_module
#Not needed for non debug builds
...
PRODUCT_COPY_FILES += \
    $(QC_PROP_ROOT)/common/config/public.libraries.txt:system/vendor/etc/public.libraries.txt
